...
d = d[d.comment=="Evaluate50"]
print d[d.iStep==100]

Index    = d["totalIter"]
iSample  = d["sampleIndex"]
print iSample
...
plt.plot(Index, pd.rolling_mean(Xoutput,1))
#plt.plot(Index, pd.rolling_mean(Xhidden.ix[:, 00:10],1))
#plt.plot(Index, Routput+2)
